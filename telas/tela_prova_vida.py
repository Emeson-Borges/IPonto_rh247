...
def criar_tela_prova_vida(page: ft.Page, db_path: str):
    """
    Tela para cadastro de facial no banco de dados.
    """
    ...
    def update_images():
        """Captura frames da câmera e detecta rostos."""
        ...
        while not stop_camera:
            ...
            if ret:
                ...
                for (x, y, w, h) in faces:
                    center = (x + w // 2, y + h // 2)
                    axes = (w // 2, h // 2)
                    cv2.ellipse(rgb_frame, center, axes, angle=0, startAngle=0, endAngle=360, color=(0, 255, 0), thickness=2)

                    # Capturar o rosto detectado
                    rosto_capturado = rgb_frame[y:y + h, x:x + w]
